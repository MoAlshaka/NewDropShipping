<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('admin.dashboard') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2">Dropping</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div>{{ __('site.ProductCatalog') }} </div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('shared-products.index') }}" class="menu-link">
                        <div> {{ __('site.SharedProducts') }}</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('affiliate-products.index') }}" class="menu-link">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="{{ route('shared-products.create') }}" class="menu-link">
                        <div> {{ __('site.AddSharedProducts') }}</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('affiliate-products.create') }}" class="menu-link">
                        <div> {{ __('site.AddAffiliateProducts') }}</div>
                    </a>
                </li>
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons mdi mdi-layers-triple-outline"></i>
                <div> {{ __('site.Categories') }}</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('categories.index') }}" class="menu-link">
                        <div> {{ __('site.AllCategories') }}</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('categories.create') }}" class="menu-link">
                        <div> {{ __('site.CreateCategory') }}</div>
                    </a>
                </li>
            </ul>
        </li>
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('countries.index') }}" class="menu-link">
                        <div> {{ __('site.AllCountries') }}</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('countries.create') }}" class="menu-link">
                        <div> {{ __('site.CreateCountry') }}</div>
                    </a>
                </li>
            </ul>
        </li>
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('transactions.index') }}" class="menu-link">
                        <div> {{ __('site.AllTransaction') }}</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('transactions.create') }}" class="menu-link">
                        <div> {{ __('site.CreateTransaction') }}</div>
                    </a>
                </li>
            </ul>
        </li>
