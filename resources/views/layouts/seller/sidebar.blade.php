<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('seller.sharedproducts.index') }}" class="menu-link">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                {{-- <li class="menu-item">
                    <a href="{{ route('seller.products.index') }}" class="menu-link">
                        <div>All Products</div>
                    </a>
                </li> --}}
                <li class="menu-item">
                    <a href="{{ route('seller.products.imported') }}" class="menu-link">
                        <div>{{ __('site.ImportProduct') }}</div>
                    </a>
                </li>
            </ul>
        </li>
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('leads.index') }}" class="menu-link">
                        <div>{{ __('site.AllLeads') }}</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('leads.create') }}" class="menu-link">
                        <div> {{ __('site.CreateLeads') }}</div>
                    </a>
                </li>
            </ul>
        </li>
